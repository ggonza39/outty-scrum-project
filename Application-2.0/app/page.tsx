...
function LogoutToast() {
  ...
  return (
    <div
      className={`fixed top-10 left-1/2 -translate-x-1/2 z-[100] transition-all duration-1000 ease-in-out
        ...
        <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
          ...
          <div className="w-full md:w-auto flex justify-center">
            {!loading ? (
              ...
              <div
                className={`${styles.loadingBtn} w-60 text-center flex justify-center items-center gap-2`}
              >
