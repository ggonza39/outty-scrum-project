...
/* -------------------------------------------------------------------------- */
/* SECTION 1: LOGIN CONTENT COMPONENT                                         */
/* -------------------------------------------------------------------------- */
...
function LoginContent() {
  ...
  // 1.2 User Profile & Greeting State
  ...
  /* -------------------------------------------------------------------------- */
  /* SECTION 2: BACKEND LOGIC & HANDLERS                                        */
  /* -------------------------------------------------------------------------- */

  // 2.1 Success Message Auto-Update
  useEffect(() => {
  ...
  // 2.2 Security: Password Validation
  ...
  // 2.3 Handler: Account Creation (Sign Up)
  ...
  // 2.4 Handler: Identity Verification (Login)
  ...
  return (
    <main className="relative min-h-screen w-full flex items-center justify-center bg-[#022c22] pt-24 pb-12 overflow-hidden">
      ...
      {isWelcoming ? (
        ...
        /* 3.3 View: Identity Portal (Login Form) */
        <div
          className={`${styles.glassCard} z-10 w-full max-w-md p-10 mx-4 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl`}
        >
          <h2
            className={`${styles.glassTitle} text-4xl font-black text-white mb-2 text-center tracking-tighter uppercase italic`}
          >
            Join the Adventure
          </h2>
          <p className="text-emerald-400 text-[10px] font-black uppercase tracking-[0.3em] text-center mb-8">
            Outty Identity Portal
          </p>

          <div className="space-y-5 text-left">
          {/* Email Input */}
            <div>
              <label className="text-white/40 text-[10px] font-black uppercase tracking-widest ml-1">
                Email Address
              </label>
              <div className="relative mt-1">
                <span className="absolute left-4 top-4 opacity-40 text-sm">
                  ✉️
                </span>
                <input
                  type="email"
          ...
          {message && (
            <div
              className={`mt-6 p-4 rounded-xl border animate-in fade-in zoom-in duration-500 ${
                isError
                  ? "bg-red-500/10 border-red-500/50 text-red-400"
                  : "bg-emerald-500/10 border-emerald-500/50 text-emerald-400"
              }`}
            >
              <p className="text-center text-[11px] font-black uppercase tracking-tight">
                {message}
              </p>
            </div>
          )}
          ...
          <div className="flex flex-col gap-3 mt-8">
            ...
            <div className="flex items-center my-2 text-white/40">
              ...
              <span className="px-4 text-[10px] font-black uppercase tracking-[0.4em]">
                OR
              </span>
              <div className="flex-grow h-px bg-white/30" />
            </div>
...
/* -------------------------------------------------------------------------- */
/* SECTION 4: PAGE EXPORT (Next.js Root)                                      */
/* -------------------------------------------------------------------------- */
