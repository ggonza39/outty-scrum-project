...
export default function MyProfile() {
  ...
  const showNext = (e: React.MouseEvent) => {
    ...
    setExpandedIndex((prev) =>
      prev !== null && prev < pictures.length - 1 ? prev + 1 : 0,
    );
  };
  ...
  const showPrev = (e: React.MouseEvent) => {
    e.stopPropagation();
    setExpandedIndex((prev) =>
      prev !== null && prev > 0 ? prev - 1 : pictures.length - 1,
    );
  };
          ...
          <div className="p-8 md:p-12 rounded-3xl bg-white/10 backdrop-blur-xl border border-white/20 shadow-2xl transition-all duration-500">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 mb-10">
              ...
              <div className="relative w-32 h-32 flex items-center justify-center">
                ...
                <div
                  className={`absolute inset-0 rounded-full border-4 transition-all duration-700 z-10 pointer-events-none ${
                    isOnline
                ...
                <section>
                  ...
                  <div className="flex flex-wrap gap-2">
                    {getArrayData(profile?.adventure_type).map((a: string) => (
                      <span
                        key={a}
                        className="px-4 py-2 bg-emerald-500/10 border border-emerald-500/30 text-emerald-400 text-[11px] font-bold rounded-full"
                      >
                        {a}
                      </span>
                    ))}
                ...
                <section>
                  ...
                  <div className="space-y-4">
                    <div className="flex justify-between items-center border-b border-white/5 pb-2">
                      <span className="text-white/60 text-xs uppercase font-bold text-[10px]">
                        Home Base
                      </span>
                        ...
                        {Array.isArray(profile?.gender_preference)
                          ...
                          : typeof profile?.gender_preference === "string"
                            ? profile.gender_preference
                                .replace(/[\[\]"]/g, "")
                                .split(",")
                                .join(" | ") // Handles string-based lists too
                            : "Not Set"}
                      </span>
                    </div>
                  </div>
            ...
            {pictures.length > 0 && (
              <section className="mt-12 pt-10 border-t border-white/10">
                <div className="flex items-center justify-between mb-6">
                  <h3 className="text-emerald-400 text-[12px] font-black uppercase tracking-widest">
                    Adventure Gallery
                  </h3>
            ...
            >
              ...
              >
                ...
                <svg
                  ...
                  strokeLinecap="round"
                  strokeLinejoin="round"
                  className="text-emerald-400 group-hover:text-black group-hover:rotate-90 transition-transform duration-300"
                >
                  <path d="M18 6 6 18" />
                  <path d="m6 6 12 12" />
                </svg>
