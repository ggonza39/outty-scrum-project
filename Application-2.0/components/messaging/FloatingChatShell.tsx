  ...
  return (
    ...
    <div className="fixed bottom-8 right-8 z-[100] flex flex-col items-end gap-4 pointer-events-none">
      ...
      <div className={`chat-container w-[360px] h-[520px] bg-black/40 backdrop-blur-3xl border border-white/10 rounded-[2.5rem] shadow-[0_25px_50px_-12px_rgba(0,0,0,0.6)] flex flex-col overflow-hidden transition-all duration-300 origin-bottom-right mb-2 ${
        isFloatingOpen
          ? 'opacity-100 scale-100 translate-y-0 pointer-events-auto' /* RE-ENABLE clicks when open */
        ...
        <div className="flex-1 overflow-y-auto relative bg-white/[0.03] custom-scrollbar">
           ...
           ) : /* SURGICAL FIX: Only mount ChatWindow if the shell is actually OPEN */
      ...
      {/* 3.4 FLOATING ACTION BUTTON (FAB) */}
          <button
            ...
            /* ADD 'pointer-events-auto' so the button still works */
      ...
      >
        ...
        {isFloatingOpen ? (
          <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="3.5" strokeLinecap="round" strokeLinejoin="round"><path d="M18 6 6 18"/><path d="m6 6 12 12"/></svg>
        ) : (
          <div className="relative">
             <svg xmlns="http://www.w3.org/2000/svg" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="group-hover:rotate-12 transition-transform"><path d="m3 21 1.9-5.7a8.5 8.5 0 1 1 3.8 3.8z"/></svg>
