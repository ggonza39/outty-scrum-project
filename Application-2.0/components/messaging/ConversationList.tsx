      ...
      {conversations.map((convo) => (
        ...
        >
          ...
          >
            ...
            <div
              className={`absolute inset-0 rounded-full border-2 border-emerald-500 z-10 pointer-events-none transition-all duration-700 ${
            ...
            <img
              src={
                convo.profile_pictures?.[0] || "https://via.placeholder.com/150"
              }
              onError={(e) => {
