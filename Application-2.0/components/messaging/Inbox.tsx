...
export default function Inbox({
  ...
  if (loading)
    return (
      <div className="p-8 text-white/20 animate-pulse uppercase text-[10px] tracking-widest">
        Loading Inbox...
      </div>
    );
  ...
  return (
    <div className="w-full border-r border-white/10 h-full bg-[#022c22]/50 backdrop-blur-xl flex flex-col overflow-x-hidden">
      ...
      <div className="p-6 border-b border-white/10 bg-[#022c22]/80">
        <h2 className="text-emerald-400 font-black uppercase tracking-[0.3em] text-[11px]">
          Messages
        </h2>
      </div>
      ...
      <div className="flex-1 overflow-y-auto overflow-x-hidden custom-scrollbar">
        {conversations.length === 0 ? (
          ...
          conversations.map((conv) => {
            const avatarUrl =
              conv.otherUser.profile_pictures?.[0] ||
            ...
            return (
              ...
              >
                ...
                >
                  {/* THE GLOW RING */}
                  <div
                    className={`absolute inset-0 rounded-full border-2 transition-all duration-700 z-10 pointer-events-none ${
                      isOnline
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p
                    className={`text-[11px] truncate mt-1 font-black uppercase tracking-widest transition-opacity ${
