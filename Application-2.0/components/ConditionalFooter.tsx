...
export default function ConditionalFooter() {
  ...
  // 4.2: HOME PAGE VERSION (Floating Text Section)
  if (isHomePage) {
    return (
  ...
  // 4.3: INTERNAL PAGE VERSION (Glassy Footer Section)
  return (
    <footer
      className={`relative z-50 w-full border-t border-white/10 py-10 md:py-12 transition-all duration-500
      ...
      <div className="text-center group cursor-default w-full px-4">
        <div className="flex flex-col md:flex-row items-center justify-center gap-3 md:gap-0">
          <p className="flex items-center justify-center whitespace-nowrap text-white/50 text-[9px] md:text-[10px] font-black uppercase tracking-[0.2em] sm:tracking-[0.4em] md:tracking-[0.7em] transition-all duration-500 group-hover:text-white">
            <span>Est. 2026</span>
            <span className="text-emerald-500/40 mx-3 transition-colors group-hover:text-emerald-400">
              •
            </span>
