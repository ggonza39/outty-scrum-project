...
//Age
    ...
    it('should return error for age outside of range', () => {
        const testData: ProfileFormData = structuredClone(defaultData);
        testData.age = "17";
        expect(validatePreferences(testData)).toBe('Please enter an age between 18 and 150, to the nearest year.');
        testData.age = "151";
        expect(validatePreferences(testData)).toBe('Please enter an age between 18 and 150, to the nearest year.');
    });
    ...
    it('should return error for empty age', () => {
        const testData: ProfileFormData = structuredClone(defaultData);
        testData.age = "";
        expect(validatePreferences(testData)).toBe('Please enter an age.');
    });
...
//Name
    ...
    it('should return error for empty name', () => {
        ...
        expect(validatePreferences(testData)).toBe('Please enter a name between 1 and 17 letters');
    });
...
//Zip Code 
    ...
    it('should return error for zip code of wrong length', () => {
        ...
        expect(validatePreferences(testData)).toBe('Please enter a valid ZIP code.');
