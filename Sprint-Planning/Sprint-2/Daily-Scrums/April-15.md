...
**Identified Impediment:**  
  - Critical backend and frontend bugs identified by the tester (Gibson) which are threatening the "Definition of Done" for Story 5 and Story 8.
  
**Impediment Removal Plan:**  
  - The team is temporarily "swarming" on bug resolution. 
  
**Responsible (if applicable):**
  - Takeshia, Hunter, Anthony, Gilberto
